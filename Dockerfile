# D-Helix Binary Verification System - Docker Image
# 
# This Dockerfile sets up the complete D-Helix environment including:
# - ANGR for binary analysis (VEX IR)
# - KLEE/PROMPT for symbolic execution of decompiled code
# - Z3 SMT solver for equivalence checking
# - FastAPI server for REST API access
#
# Build: docker build -t d-helix .
# Run:   docker run -p 10012:10012 d-helix
#
# For production with multiple workers:
#   docker run -p 10012:10012 d-helix uvicorn api_server:app --host 0.0.0.0 --port 10012 --workers 12
...
# ============================================================================
# STEP 3: GCC 11 (required for C++ support)
# ============================================================================
...
# ============================================================================
# STEP 4: Clang 16 (for compiling decompiled code)
# ============================================================================
...
# ============================================================================
# STEP 5: LLVM 3.8 (for KLEE/PROMPT) & Z3 Solver
# ============================================================================
# LLVM 3.8
...
RUN wget https://github.com/Z3Prover/z3/releases/download/z3-4.9.1/z3-4.9.1-x64-glibc-2.31.zip && \
    ...
    rm z3-4.9.1-x64-glibc-2.31.zip
...
# Apply patches to ANGR for VEX IR dumping
...
# ============================================================================
# STEP 7: KLEE-uClibc (for KLEE/PROMPT)
# ============================================================================
...
# ============================================================================
# STEP 8: PROMPT (KLEE fork for decompiled code analysis)
# ============================================================================
...
# ============================================================================
# STEP 9: Ghidra (optional - for alternative decompilation)
# ============================================================================
...
# Install Python dependencies into the angr venv
RUN /root/.virtualenvs/angr/bin/pip install wrapt-timeout-decorator six numpy

# ============================================================================
# STEP 11: Create Test Directory Structure
# ============================================================================
...
# Create a simple test binary for verification
...
#   docker run d-helix python test_comprehensive.py
